...
{
    // Include the Owner and Knjiga related data
...
public IActionResult Create()
{
    ...
    var availableBooks = _context.Knjige
        .Where(knjiga => !_context.Rezervacije.Any(r => r.KnjigaId == knjiga.KnjigaId))
        .Select(knjiga => new SelectListItem
        {
    ...
    ViewData["KnjigaId"] = availableBooks;
    return View();
}
